  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      if (!result.detections || result.detections.length === 0) {
        setError(
          "No waste objects detected in this image. Try taking a clearer photo close to the item.",
        );
        setLoading(false);
        return;
      }
      ...
      {mode === "idle" && (
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
          ...
          >
            ...
            <div style={{ textAlign: "center" }}>
              ...
              <p style={{ color: "var(--text-muted)", fontSize: "0.8rem" }}>
                Point at any waste item to identify it
              </p>
            </div>
          </div>
          ...
          <div style={{ marginTop: "1rem" }}>
            <p style={{ fontSize: "0.85rem", fontWeight: 700, marginBottom: "0.5rem", color: "var(--text-muted)" }}>
              Test with Mock Scans:
            </p>
          ...
          >
            ...
            >
              ...
              >
                ...
                <path d="M5 7H3a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h18a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-2" />
                <path d="M9 4h6" />
              </svg>
            </button>
            <button
