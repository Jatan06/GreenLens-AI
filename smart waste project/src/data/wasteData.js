// Smart Waste Management System - Mock Data & Constants (AMC AI Inspired)
...
export const INITIAL_IOT_BINS = [
  {
    ...
    lng: -122.4194,
    fillLevel: 89,
    status: "Urgent", // Urgent (>85), Warning (65-85), Normal (<65)
    battery: 92,
    tempC: 24.5,
    capacityLiters: 240,
...
export const INITIAL_REWARDS = [
  {
    id: "reward-1",
    title: "$5 Campus Coffee Voucher",
    vendor: "EcoCafe",
    pointsRequired: 250,
    icon: "Coffee",
    category: "Food & Beverage",
    description: "Get a free artisanal organic coffee at any campus coffee spot."
  },
  {
    id: "reward-2",
    title: "1-Day Transit Day Pass",
    vendor: "City Transit",
    pointsRequired: 400,
    icon: "Bus",
    category: "Transportation",
    description: "Unlimited 24-hour bus and metro rides across the city network."
  },
  {
    id: "reward-3",
    title: "Plant a Native Tree Certificate",
    vendor: "GreenEarth NGO",
    pointsRequired: 500,
    icon: "Trees",
    category: "Eco Impact",
    description: "Plant a native sapling with your custom name on the global forest map."
  },
  {
    id: "reward-4",
    ...
    description: "Premium insulated 750ml thermal bottle with smart temperature indicator."
  }
];

export const MOCK_BOT_QA = [
  {
    keywords: ["pizza", "box", "greasy", "grease"],
    answer: "If the pizza box is clean and dry, recycle it in the Paper/Cardboard bin! If it has heavy cheese or grease stains, tear off the greasy bottom (put in compost/trash) and recycle the clean lid."
  },
  {
    keywords: ["battery", "batteries", "lithium", "cell"],
    answer: "Batteries must NEVER go in general trash or standard recycling bins! They are a severe fire hazard. Bring them to our E-Waste Smart Depot (Red Bin) or a local electronic recycling center."
  },
  {
    keywords: ["styrofoam", "thermocol", "foam"],
    answer: "Expanded Polystyrene (Styrofoam) is generally not accepted in standard curbside bins. Take it to specialized drop-off points or reuse it as packaging material."
  },
  {
    keywords: ["coffee cup", "to go cup", "starbucks"],
    answer: "Most paper coffee cups have a hidden plastic lining. Plastic lids go to Plastics (Blue Bin), cardboard sleeves to Paper, and the cup itself to General Waste unless specified compostable!"
  },
  {
    keywords: ["glass", "broken glass", "bottle"],
    answer: "Rinse food and beverage glass bottles and drop them in the Glass Bin. However, broken window glass, mirror glass, or ceramic mugs should NOT go into container recycling—wrap safely and place in General Waste."
  }
];
