...
export default function IotBins({ bins, setBins, onDispatchRoute }) {
    ...
    <div className="animate-fade-in" style={{ padding: "0 16px 32px 16px" }}>
        ...
        {[
          ...
          <button
            ...
            style={{
              padding: "8px 16px",
              borderRadius: "20px",
              border: filter === f.id ? "1px solid #10b981" : "1px solid var(--border-color)",
              background: filter === f.id ? "rgba(16, 185, 129, 0.15)" : "var(--bg-card)",
              color: filter === f.id ? "#10b981" : "var(--text-secondary)",
              fontWeight: 600,
              fontSize: "0.85rem",
              cursor: "pointer",
      ...
      <div style={{
        ...
        {filteredBins.map((bin) => {
          ...
          const statusColor = isUrgent ? "#ef4444" : isWarning ? "#f59e0b" : "#10b981";
          ...
          return (
            <div key={bin.id} className="glass-card" style={{ padding: "24px" }}>
              ...
              <div style={{
                ...
                <div>
                  <div style={{ display: "flex", alignItems: "center", gap: "4px", fontSize: "0.72rem", color: "var(--text-muted)" }}>
                    <Thermometer size={12} color="#f59e0b" /> Temp
                  </div>
                ...
                <div>
                  <div style={{ display: "flex", alignItems: "center", gap: "4px", fontSize: "0.72rem", color: "var(--text-muted)" }}>
                    <Battery size={12} color="#10b981" /> Battery
                  </div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px" }}>
                ...
                >
                  <Zap size={14} color="#f59e0b" /> Compact (-25%)
                </button>
                ...
                >
                  <CheckCircle2 size={14} color="#10b981" /> Mark Serviced
                </button>
              </div>
