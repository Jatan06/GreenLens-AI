      ...
      <div style={{
        ...
        <div className="glass-card" style={{ padding: "20px" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "10px" }}>
            <span style={{ fontSize: "0.8rem", color: "var(--text-secondary)", fontWeight: 600 }}>LANDFILL DIVERSION RATE</span>
          ...
          <div style={{ fontSize: "0.78rem", color: "var(--text-secondary)" }}>+12.3% vs previous period</div>
        </div>
        ...
        <div className="glass-card" style={{ padding: "20px" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "10px" }}>
            <span style={{ fontSize: "0.8rem", color: "var(--text-secondary)", fontWeight: 600 }}>ESG TARGET COMPLIANCE</span>
          ...
          {forecastData?.daily_predictions ? (
            <div style={{ display: "flex", flexDirection: "column", gap: "10px", marginBottom: "20px" }}>
              {forecastData.daily_predictions.slice(0, 5).map((pred, i) => (
                <div key={i} style={{ display: "flex", justifyContent: "space-between", padding: "10px 14px", background: "var(--bg-main)", borderRadius: "10px", border: "1px solid var(--border-color)", fontSize: "0.88rem" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
              <div style={{ padding: "14px", background: "var(--bg-main)", borderRadius: "12px", border: "1px solid var(--border-color)", display: "flex", alignItems: "center", gap: "12px" }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: "0.78rem", color: "var(--text-secondary)" }}>Active in Zone A, B, and C</div>
                </div>
              </div>
